  ...
  plugins: [
    ...
    {Oban.Plugins.Cron,
     crontab: [
       ...
       {"0 * * * *", SocialScribe.Workers.HubSpotTokenRefresher}
     ]}
  ]
  ...
  providers: [
    ...
    facebook:
      {Ueberauth.Strategy.Facebook,
       [
         default_scope: "email,public_profile,user_link,user_posts"
       ]},
    hubspot:
      {Ueberauth.Strategy.Hubspot,
       [
         default_scope: "oauth crm.schemas.contacts.read crm.objects.contacts.read crm.schemas.contacts.write crm.objects.contacts.write"
       ]}
  ]
